...
namespace KeyGeneralPurposeLibrary.Assets {
  public class KeyGenLibFileAssetManager : KLibComponent {
    ...
    public void InitializeLocalFolders(string modName) {
    ...
    public void MoveTraitsToFolder(string modName) {
    ...
    public void MoveItemsToFolder(string modName) {
      string pathToCheck = Path.GetFullPath(BepInEx.Paths.PluginPath);
    ...
    public void MoveSpritesToFolder(string modName) {
      string pathToCheck = Path.GetFullPath(BepInEx.Paths.PluginPath);
    ...
    public void MoveModFilesToOtherMod(string original, string newMod) {
