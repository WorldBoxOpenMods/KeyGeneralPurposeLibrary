...
namespace KeyGeneralPurposeLibrary.Classes {
  public class CustomTrait : ActorTrait {
    ...
    public CustomTrait(string author, string description, string sprite) {
      Author = author;
    ...
    */
    ...
    public void LoadTrait(string trait) {
      ...
      Version = generalInfoDictionary["trait_version"];
    ...
    public void LoadVersionOnePointOneTrait(string trait) {
      ...
      Version = traitDataDictionary["trait_version"];
